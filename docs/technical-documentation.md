...
The **B**CODMO **S**emantic **M**odel \(**BCO-SM**\) is created within BCODMONT and acts as a controlled vocabulary for the BCODMO data managers to annotate data with. 
